...
function InfoRow({
  ...
  return (
    <div className="flex items-start gap-3 rounded-[var(--radius-md)] border border-[var(--border-strong)] bg-[var(--surface-3)] p-3 dark:border-[var(--border-strong)] dark:bg-[var(--surface-3)]">
      <div className="rounded-full border border-[var(--border-strong)] bg-[var(--surface-3)] p-2 dark:border-[var(--border-strong)] dark:bg-zinc-800">
      ...
      <div className="min-w-0">
        ...
        {href ? (
          <Link
            ...
            className="dashboard-focusable mt-1 inline-flex break-all text-sm leading-6 text-[var(--text-primary)] underline decoration-zinc-300 underline-offset-4 hover:decoration-zinc-500 dark:decoration-zinc-600 dark:hover:decoration-zinc-300"
          >
            {value}
          </Link>
        ) : (
...
function Avatar({ logoUrl, businessName }: { logoUrl: string | null; businessName: string }) {
  ...
  if (!logoUrl || logoError) {
    return (
      <div className="flex h-24 w-24 items-center justify-center rounded-[1.65rem] border-4 border-[var(--border-strong)] bg-zinc-800 text-3xl font-semibold text-white shadow-[0_20px_40px_-28px_rgba(15,23,42,0.75)] dark:border-[var(--border-strong)] dark:bg-zinc-900 dark:text-[var(--text-primary)] sm:h-28 sm:w-28 md:h-32 md:w-32">
  ...
  return (
    <Image
      ...
      width={128}
      height={128}
      className="h-24 w-24 rounded-[1.65rem] border-4 border-[var(--border-strong)] object-cover shadow-[0_20px_40px_-28px_rgba(15,23,42,0.75)] dark:border-[var(--border-strong)] sm:h-28 sm:w-28 md:h-32 md:w-32"
      unoptimized
