...
export default function ServicesHeader({ services, onCreate, onManageCategories }: ServicesHeaderProps) {
  ...
  return (
    <header className="overflow-hidden rounded-[--radius-lg] border border-[var(--border-strong)] bg-[var(--surface-3)] p-6 shadow-[var(--shadow-sm)] dark:border-[var(--border-strong)] dark:bg-[var(--surface-3)] dark:shadow-[--shadow-sm] lg:p-8">
      ...
      <div className="relative z-10 mt-8 grid gap-4 grid-cols-1 xs:grid-cols-2 lg:grid-cols-3">
        ...
        <article className="group relative overflow-hidden rounded-[var(--radius-lg)] border border-blue-200/60 bg-blue-50/50 p-5 shadow-[inset_0_1px_rgba(255,255j,255,0.4)] backdrop-blur-md transition-all hover:bg-blue-100/50 hover:shadow-md dark:border-blue-900/30 dark:bg-blue-900/10 dark:hover:bg-blue-900/20">
        ...
        <article className="group relative overflow-hidden rounded-[var(--radius-lg)] border border-amber-200/60 bg-amber-50/50 p-5 shadow-[inset_0_1px_rgba(255,255,255,0.4)] backdrop-blur-md transition-all hover:bg-amber-100/50 hover:shadow-md dark:border-amber-900/30 dark:bg-amber-900/10 dark:hover:bg-amber-900/20">
